...
router.put('/contacts/profile/put/:contactId', userMiddleware.isLoggedIn, putContact.profile)
router.post('/contacts/logs/img', userMiddleware.isLoggedIn, addContact.addLogImg)
router.delete('/image/:image', userMiddleware.isLoggedIn, addContact.delLogImg)
